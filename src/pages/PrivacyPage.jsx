    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          <div className={styles.appName}>센티브 (Scentive)</div>
          <h1 className={styles.title}>개인정보처리방침</h1>
          <div className={styles.effectiveDate}>시행일자: 2026년 3월 22일</div>
        </header>

        <div className={styles.intro}>
          (주)센티브(이하 "회사")는 「센티브(Scentive)」 서비스(이하 "서비스") 이용자의 개인정보를 소중히 여기며,
          「개인정보 보호법」을 준수합니다.
        ...
        <section className={styles.section}>
          ...
          <div className={styles.contactCard}>
            ...
            <p>성명: 배성우</p>
            <p>소속: (주)센티브</p>
            <p>이메일: <a href="mailto:scentive@gmail.com">scentive@gmail.com</a></p>
        ...
        <footer className={styles.footer}>
          <p>(주)센티브 (Scentive) &nbsp;|&nbsp; 개인정보처리방침 시행일자: 2026년 3월 22일</p>
        </footer>
