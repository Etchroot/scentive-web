...
const GlowingEffect = memo(function GlowingEffect({
  ...
  const inactiveCls = [
    ...
    glow && styles.inactiveBorderVisible,
    variant === 'white' && styles.inactiveBorderWhite,
    disabled && styles.inactiveBorderOnly,
  ]
    .filter(Boolean)
    .join(' ');
  ...
  const containerCls = [
    ...
    glow && styles.glowContainerVisible,
