...
const LINES = [
  {
    ...
    desc: '슬플 때, 기쁠 때, 마음을 전하고 싶을 때 우리는 글을 씁니다. 일기 한 줄에도, 메시지 하나에도 감정은 고스란히 배어 있습니다. 글은 인간이 자신을 표현하는 가장 솔직한 기록입니다.',
  },
  {
    index: '02', text: '향은 추억을 담습니다.', keyword: '추억',
    desc: '익숙한 향 하나가 잊었던 순간을 되살립니다. 향은 사람과 사람을 이어주고, 누군가에게는 말보다 깊이 자신을 표현하는 언어가 됩니다.',
  },
  {
    index: '03', text: '우리는 그 사이를 잇습니다.', keyword: '잇습니다',
    desc: '오래전부터 향을 감정·감각과 연결하려는 연구와 시도는 끊이지 않았습니다. 그 축적이 향수 산업을 키웠고, 오늘날 사람들은 향에서 정체성과 서사를 발견합니다. Scentive는 그 연결고리를 데이터로 완성합니다.',
  },
  {
    index: '04', text: '감정은 향기가 되어 데이터에 남습니다.', keyword: '데이터',
    desc: '그럼에도 향은 오랫동안 감각으로만 유추되어 왔습니다. Scentive는 수만 건의 일기와 공개 데이터, 향 분자의 화학적 특성까지 학습 데이터로 삼아 감정과 향을 연결하는 정밀한 데이터베이스를 구축합니다.',
  },
  {
    index: '05', text: '데이터는 거대한 향의 지도가 됩니다.', keyword: '지도',
    desc: '추상적이었던 향을 정량적 데이터로 분석할 수 있다는 것, 그 자체가 혁신입니다. Scentive의 향 지도는 개인의 일기에서 출발해 누구에게든, 어떤 상황에든 범용적으로 적용될 수 있는 인프라로 성장합니다.',
  },
];
